...
if ( ! function_exists( 'understrap_widgets_init' ) ) {
	...
	function understrap_widgets_init() {
		...
		register_sidebar(
			array(
				'name'          => __( 'Prefooter', 'understrap' ),
				'id'            => 'prefooter',
				'description'   => __( 'Full sized prefooter widget with dynamic grid', 'understrap' ),
				'before_widget' => '<div id="%1$s" class="prefooter-widget %2$s dynamic-classes"><div class="container">',
				'after_widget'  => '</div><!-- .prefooter-widget --></div>',
